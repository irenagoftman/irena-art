          ...
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 20, opacity: 0 }} className="relative max-w-5xl w-full bg-white rounded-3xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="mt-6 text-sm text-neutral-700 leading-relaxed">"Despite all the chaos around, she still dares to dream." A study of gaze, rhythm, and color — part of an ongoing series exploring the mosaic of the soul.</p>
                <div className="mt-6 flex flex-wrap gap-3">
